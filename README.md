...
A site dedicated to the collection and dissemination of local open data in the Cheltenham and Gloucestershire area in the UK. Pages are built from official and public sources (ONS/Nomis, BODS, Ofcom, DfE, GOV.UK, OpenStreetMap and more) and refreshed automatically on a schedule.
...
- [Post Office locations](https://cheltenham-od.uk/cheltenham-post-office-locations)
- [InPost self-service locker locations](https://cheltenham-od.uk/cheltenham-inpost-lockers)
- [DPD Pickup points](https://cheltenham-od.uk/cheltenham-dpd-pickup-points) (shops, newsagents and kiosks that accept parcel drop-offs)
...
- [Opticians](https://cheltenham-od.uk/cheltenham-opticians), with a map and who can get a free NHS sight test
...
- [Recycling banks, centres and a recycling FAQ](https://cheltenham-od.uk/cheltenham-recycling)
- [Points of interest, museums, historic sites and blue plaques](https://cheltenham-od.uk/cheltenham-points-of-interest)
- [Third spaces and community hubs](https://cheltenham-od.uk/cheltenham-third-spaces)
- [Places to stay](https://cheltenham-od.uk/staying-in-cheltenham), including a dedicated [Cheltenham Festival accommodation guide](https://cheltenham-od.uk/cheltenham-festival-accommodation)
...
- [Confirmed public holidays](https://cheltenham-od.uk/cheltenham-public-holidays)

### Community support

- [Local food banks and their current needs](https://cheltenham-od.uk/cheltenham-foodbank-needed-items)
- [Helplines and support contact numbers](https://cheltenham-od.uk/cheltenham-helpful-contacts-reports)

### Cheltenham facts & figures
...
- [University of Gloucestershire campuses in Cheltenham and Gloucester](https://cheltenham-od.uk/university-of-gloucestershire), with a map and what is taught where
...
- [Average private rents by month since 2015, by bedrooms and property type](https://cheltenham-od.uk/cheltenham-rent-prices), from the ONS Price Index of Private Rents

### Weather

- [10-day weather forecast for Cheltenham](https://cheltenham-od.uk/cheltenham-10-day-weather-forecast)

### News

- [Local news](https://cheltenham-od.uk/cheltenham-news) aggregated and updated hourly
- [Local events](https://cheltenham-od.uk/cheltenham-events) - what's on next week.

### Local guides

- [Moving to Cheltenham](https://cheltenham-od.uk/moving-to-cheltenham)
- [Student guide to Cheltenham](https://cheltenham-od.uk/student-guide-to-cheltenham)
- [Visiting Cheltenham](https://cheltenham-od.uk/visiting-cheltenham)
- [Cheltenham racing festival](https://cheltenham-od.uk/cheltenham-festival-accommodation) - races guide and accomodation
