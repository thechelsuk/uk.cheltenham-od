...
Cheltenham Open Data has published a new [dentists page](/cheltenham-dentists), listing the dental practices in the NHS's directory across the GL50 to GL53 postcodes.
...
### What Does the Dentists Page Show?

- The dental practices in the NHS directory in Cheltenham's GL50 to GL53 postcodes, on a map and in a table, with guidance on finding an NHS dentist.
...
### Can I Tell Which Dentists Are Taking New NHS Patients?

- Not from this page. Ring the practice and use the NHS's Find a dentist service.

### Why Isn't a Private Dentist Listed?

- The directory is the NHS's, so practices that only offer private care are mostly not in it.
