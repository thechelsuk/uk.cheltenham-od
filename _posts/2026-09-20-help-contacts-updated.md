...
Cheltenham Open Data has added more numbers to the [help and support page](/cheltenham-helpful-contacts-reports), so the ones people need in a hurry are in one place.

The main list of useful phone numbers now includes:

- 999 for emergencies and NHS 111 for urgent medical help that isn't a 999 emergency
- 105 to report a power cut
- Floodline and the Environment Agency incident hotline for flooding
...
- Use the [contact form](/contact), or post in the [r/Cheltenham subreddit](https://www.reddit.com/r/Cheltenham/).
